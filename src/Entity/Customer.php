...
class Customer
{
     ...
     * @Assert\Email(message="Le format de l'adresse est incorrect")
     */
    private $email;
    ...
    /**
     * Permet de récuperer le montant  total des factures
     * @return float
     * @Groups({"customers_read"})
     */
    ...
    /**
     * Permet de récuperer le montant  total des factures non payé ou non annulé
     * @return float
     * @Groups({"customers_read"})
     */
