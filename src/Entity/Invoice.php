 ...
 *          "swagger_context" = {
 *              "summary" = "Incrementer la facture",
 *              "description" = "Incrementer le chrono",
 *            }
 *        },
 *     },   
 *     attributes={
...
class Invoice
{
     ...
     * @Assert\NotBlank(message="Le date d'envoie doit être rensignée")
     */
    private $sentAt;
     ...
     * @Assert\NotBlank(message="Le client de la facture d'envoie doit être rensigné")
     */
    private $customer;
     ...
     * @Assert\Type(type="integer", message="Le chrnono de la facture doit être un nombre")
     */
    private $chrono;
